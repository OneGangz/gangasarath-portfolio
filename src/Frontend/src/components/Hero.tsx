      ...
      <div style={{ maxWidth: '800px' }}>
        ...
        >
          ...
          <p className="hero-text">
            I am Gangasarath S, a Senior Technical Analyst and Senior .NET Developer with 13+ years of experience specializing in C#, .NET Core, Microservices, and SQL Server performance optimization.
          </p>
          <div className="hero-buttons" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '1.25rem', marginLeft: '1.5rem' }}>
              ...
              <a href="https://linkedin.com/in/OneGangz" target="_blank" rel="noreferrer" className="nav-link" style={{ display: 'flex', alignItems: 'center' }}><Linkedin size={24} /></a>
            </div>
          </div>
        </motion.div>
      </div>
